...
public class TripOrderSqlConstants {
    ...
    public static final String FIND_TRIP_ORDER = "select " +
            ...
            CAR_TABLE_NAME + "." + CarSqlConstants.CarFields.STATUS + " as " + CAR_PREFIX + CarSqlConstants.CarFields.STATUS + ", " +
            ...
            " where " + TO_TABLE_NAME + "." + TripOrderFields.ID + "=?";


    public static final String UPDATE_TRIP_ORDER = "update " + TO_TABLE_NAME +
            " set " + TripOrderFields.DEPARTURE_ADDRESS + " = " + "?, " +
