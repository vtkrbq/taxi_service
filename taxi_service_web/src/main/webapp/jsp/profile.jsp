            ...
            <table style="font-size: 24px; font-family: Exo 2;">
                <caption>
                    <div style="padding-left: 0px; display: inline-block;">
                        ...
                        <a href="${pageContext.request.contextPath}/editUser" class="btn btn-secondary" style="background-color: black; width: 150px; margin-left: 40px;"><fmt:message key="edit.button" /></a>
                    </div>
                </caption>
                <tr>
